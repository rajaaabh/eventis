...
export default function EvenementCard({ evenement }) {
    ...
    const dateDebut = parseDate(evenement.date_debut)
        ...
        <div className="bg-white rounded-3xl overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 flex flex-col shadow-sm" style={{ border: '1px solid #f0f0f0' }}>
            ...
            <div className="px-4 pb-4 flex flex-col flex-1">
                ...
                <Link
                    ...
                    className="mt-auto w-full py-3 rounded-2xl font-bold text-sm text-white text-center no-underline flex items-center justify-center bg-red-500 hover:bg-red-600 transition-colors"
                >
                    S'inscrire
                </Link>
            </div>
